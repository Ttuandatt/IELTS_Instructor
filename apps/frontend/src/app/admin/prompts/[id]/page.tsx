...
export default function PromptDetailPage() {
    ...
    const { data: subsData } = useQuery({
        ...
        queryFn: () => apiClient.get(`/admin/prompts/${id}/submissions?page=${subPage}&limit=10`).then(r => r.data),
        enabled: !!data,
    });
        ...
        <div className="max-w-5xl mx-auto p-6 md:p-8">
            ...
            <div className="flex items-center justify-between mb-8">
                <div className="flex items-center gap-4">
                    <Link href="/admin/prompts" className="text-gray-500 hover:text-gray-900">
                ...
                <Link href={`/admin/prompts/${id}/edit`} className="flex items-center gap-2 px-4 py-2 border rounded-lg text-gray-700 hover:bg-gray-50">
